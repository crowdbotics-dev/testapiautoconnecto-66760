...
## Project Structure
    ...
    ├── testapiautoconnecto_66760  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_66760`
...
2. Clone this repo and `cd testapiautoconnecto_66760`
